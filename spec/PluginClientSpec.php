...
class PluginClientSpec extends ObjectBehavior
{
    ...
    public function it_injects_debug_plugins(HttpClient $httpClient, ResponseInterface $response, RequestInterface $request, Plugin $plugin0, Plugin $plugin1, Plugin $debugPlugin)
    {
        $plugin0
            ->handleRequest(
                $request,
